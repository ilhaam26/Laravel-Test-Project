...
return [
    ...
    | the validation class. Some of these rules have multiple versions, such
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The following language lines are used to swap placeholders with something
    | more reader friendly such as "Email Address" instead of "email". This
    | helps us make the messages more expressive.
    |
    */
